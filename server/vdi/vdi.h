...
class VDI : public QObject
	...
	public:
		...
		/*********************************************************************\
		|* Opcode: 3   : Clear a workstation
		\*********************************************************************/
		void v_clrwk(Transport *io, Workstation *ws);

		/*********************************************************************\
		|* Opcode 5.1  : Query the number of character cells on the alpha
		|*               display
		\*********************************************************************/
		...
		/*********************************************************************\
		|* Opcode 5.2  : Exit alpha mode. This clears the screen and disables
		|*               the alpha cursor
		\*********************************************************************/
		void v_exit_cur(Transport *io, Workstation *ws);

		/*********************************************************************\
		|* Opcode 5.3  : Enter alpha mode. This clears the screen and enables
		|*               the alpha cursor
		\*********************************************************************/
		...
		/*********************************************************************\
		|* Opcode 39    : Request text alignment and get the actual set values
		\*********************************************************************/
		...
		/*********************************************************************\
		|* Opcode 59    : Set a pixel's RGB. Range of r,g,b = 0..1000
		\*********************************************************************/
		void vs_pixrgb(int handle, int16_t x, int16_t y, int16_t *rgb);
		void vs_pixrgb(Transport *io, ClientMsg &cm);

		/*********************************************************************\
		|* Opcode 60    : Get a pixel's RGB. Range of r,g,b = 0..1000
		\*********************************************************************/
		void vq_pixrgb(int handle, int16_t x, int16_t y, int16_t *rgb);
		void vq_pixrgb(Transport *io, ClientMsg &cm);
